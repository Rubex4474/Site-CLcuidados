...
>(({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }, ref) => {
  ...
  React.useEffect(() => {
    if (!api) return;
    // Sincroniza o estado inicial de canScrollPrev/Next assim que a
    // instância do embla fica pronta — não há como derivar isso durante o
    // render, já que `api` só existe depois que o carrossel monta.
      ...
      <Button
        ...
        className={cn(
          ...
          orientation === "horizontal"
            ? "-left-3 top-1/2 -translate-y-1/2 md:-left-14"
    ...
    return (
      <Button
        ...
        className={cn(
          "absolute rounded-full",
          orientation === "horizontal"
            ? "-right-3 top-1/2 -translate-y-1/2 md:-right-14"
